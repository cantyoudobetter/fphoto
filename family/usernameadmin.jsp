...
//System.out.println("HIMIKE");
if (request.getParameter("submituser") != null) {
		
		if (!dao.checkUser(request.getParameter("username").trim())) {
			//System.out.println("HIMIKEINHERE");

			dao.createAdminUser(request.getParameter("username").trim(),request.getParameter("password").trim(),request.getParameter("realname").trim(),Integer.parseInt(request.getParameter("family")));
...
//Menu Config
    ...
    String userName = "";
    String helpText = "Step 2 of 2: Enter User Information.";
// end Menu Config
%>
...
&nbsp;
<form method="POST" action="usernameadmin.jsp" name="myForm">
